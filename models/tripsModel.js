...
function findMembers(id){
  return db('trips')
    ...
    .where('trips.id', id)
    .select("trips.id as trip_id", "trips.trip_name as trip_name", "trips.user_id as tripOwner_id", "trips.close_trip as close_trip", "tripMembers.trip_username as trip_username")
}
